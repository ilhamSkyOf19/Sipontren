...
const SectionFormulir = () => {
    ...
    return (
        <div className='w-full min-h-[100vh] flex flex-col justify-start items-center pt-12 '>
            ...
            <div className='w-full flex flex-col justify-start items-center px-4 gap-2 pt-10 pb-12'>
                <p className='w-full text-sm text-slate-600'>*Pilih sesuai jenis sekolah</p>
                {/* NISN */}
                ...
                <div className='w-full flex flex-col justify-start items-start gap-4'>
                    <p className='text-xs'>*Pastikan data yang anda masukan sudah benar</p>
                    <button type="submit" className="w-full py-3 bg-primary-blue text-white rounded-lg hover:bg-secondary-blue hover:duration-200 text-md">Kirim</button>
                </div>
            </div>
