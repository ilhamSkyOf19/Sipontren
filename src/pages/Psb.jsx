...
const SectionService = () => {
    return (
        <LayoutSectionBg pb={4} pt={4} size={'cover'}>
                ...
                <div className='w-full flex flex-col justify-start items-start'>
                    ...
                    <div className='w-full flex flex-col justify-start items-start gap-6 pt-12'>
                        <div className='w-full'>
                            ...
                            <p className='text-sm md:text-lg'>Calon santri dapat melakukan pendaftaran melalui website pondok pesantren atau dapat langsung datang di kampung kami yang berada di JL. AR. Fakhrudin No. 2. Tanjung Harapan, Sep. Banyak</p>
                        </div>
                        <div className='w-full'>
                            <TextLgBlue text={'Melakukan Tes/Ujian'} custom={'font-semibold'} />
                            <p className='text-sm md:text-lg'>Tes tulis meliputi tes baca tulis Al-Qur'an, hafalan surat-surat pendek, praktek ibadah, pengetahuan umun dan PAI(pendidikan Agama Islan), serta wawancara orang tua dan santri</p>
                        </div>
                        <div className='w-full'>
                            <TextLgBlue text={'Pengumuman Pendaftaran'} custom={'font-semibold'} />
                            <p className='text-sm md:text-lg'>Pengumuman kelulusan calon santri akan segera di umumkan melalui website atau whatsapp grup</p>
                        </div>
                    </div>
                    <AnimationThreeImg bg={'primary-blue'} />
                </div>
                <div className='w-full h-[3rem] bg-primary-blue rounded-lg md:h-[5rem]'></div>
