            ...
            <SlideDownService id={1} active={active} setActive={setActive} title="Waktu Pelayanan Pendaftaran" no="01" first={true} >
                <div className='w-full px-5 flex flex-col justify-start items-start gap-4'>
                    <div className='w-full flex flex-col justify-start items-start gap-1'>
                        ...
                        <p className='text-sm text-slate-500'>Pondok Pesantren Muhammadiyah Al-Amin Seputih Banyak - Lampung Tengah</p>
                    </div>
                    <div className='w-full flex flex-col justify-start items-start gap-1'>
                ...
                <div className='w-full px-5 flex flex-col justify-start items-start gap-4'>
                    ...
                    <div className='w-full pl-2 flex flex-col justify-start items-start gap-4'>
                        <ol className='list-disc list-outside px-5 space-y-1'>
                            <li className='text-primary-blue text-sm'>Mengisi formulir pendaftaran (online/offline)</li>
                            <li className='text-primary-blue text-sm'>Foto berwarna (3x4) 4 lembar</li>
                            <li className='text-primary-blue text-sm'>FC. Akta Kelahiran</li>
                            <li className='text-primary-blue text-sm'>FC. Kartu Keluarga 3 lembar</li>
                            <li className='text-primary-blue text-sm'>FC. KTP orang tua, masing-masing 2 lembar</li>
                            <li className='text-primary-blue text-sm'>FC. KIP/KTS 2 lembar (bila ada)</li>
                        </ol>
                    </div>
                </div>
            </SlideDownService>
            <SlideDownService id={4} active={active} setActive={setActive} title="Pusat Bantuan" no="04" first={false} >
                <div className='w-full px-5 flex flex-col justify-start items-start gap-2'>
                    ...
                    <div className='w-full flex-col justify-start items-start pl-2'>
                        <p className='text-sm text-slate-500'>name : +62 822-7821-9515</p>
                        <p className='text-sm text-slate-500'>name : +62 822-7821-9515</p>
                    </div>
                </div>
            </SlideDownService>
