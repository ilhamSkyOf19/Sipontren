...
const InputFormulir = ({ value, handleChange, placeholder, nameInput, tipe, label, max, tipeKeyboard, borderStyle, triger }) => {
    return (
        <div className='w-full flex flex-col justify-start items-start gap-1'>
            <label htmlFor={nameInput} className='text-md text-slate-900 mb-2'>{label}</label>
            ...
            <p className='text-[0.7rem] text-red-500 transition-opacity duration-300' style={triger ? { opacity: 1 } : { opacity: 0 }}>
