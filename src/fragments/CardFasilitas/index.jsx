...
const CardFasilitas = ({ img, nama, deskripsi }) => {
    return (
        <div className='w-[90%] h-[15rem] bg-white rounded-xl shadow-xl flex flex-col justify-between items-center overflow-hidden shrink-0 md:w-[70%] md:h-[25rem] lg:w-[33%] lg:h-[18rem]'>
