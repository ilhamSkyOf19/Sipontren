...
const AnimationThreeImg = ({ bg }) => {
    return (
        <div className='w-full h-[40vh] flex flex-col justify-end items-center rounded-4xl overflow-hidden md:h-[65vh]'>
            <div className={`w-[90%] h-[13rem] flex flex-col justify-center items-center  rounded-3xl relative bg-${bg} md:w-[80%] md:h-[28rem]`}>
                <motion.div
                    animate={{ y: [0, 20, 0] }}
