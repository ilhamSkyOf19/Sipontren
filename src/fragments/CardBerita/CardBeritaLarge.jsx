...
const CardBeritaLarge = () => {
    return (
        <div className='w-full h-[47rem] flex flex-col justify-start items-start overflow-hidden gap-6'>
            ...
            <div className='flex flex-col justify-start items-start gap-3'>
                <p className='w-full h-[8.5rem] text-[1.4rem] font-[400]'>
                    Kerja Sama Tim Mahasiswa UM Metro Dengan Pondok Pesantren Muhammadiyah Al-Amin Dalam ...
                </p>
                <p className='w-full h-[7.5rem] text-md text-slate-500'>
