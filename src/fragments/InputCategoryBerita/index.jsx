...
const InputCategoryBerita = ({ register, error, nameInput }) => {
    return (
        <div className='w-full flex flex-col justify-start items-start gap-2 relative md:flex-1/3 lg:w-[40%]'>
            ...
            >
                <option value="" className='text-slate-400 text-[0.5rem] lg:text-sm'>-- Pilih categori berita --</option>
                <option value="berita" className='text-[0.5rem] lg:text-sm'>Berita</option>
                <option value="artikel" className='text-[0.5rem] lg:text-sm'>Artikel</option>
            </select>
...
export default InputCategoryBerita
